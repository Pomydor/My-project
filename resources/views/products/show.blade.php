    ...
    <form action="{{route('cart.add')}}" method="post" class="addtocart">
        ...
        <section class="h-100 gradient-custom-2">
                        ...
                        <div class="card">
                            ...
                            <div class="p-4 text-black" style="background-color: #FFFFFF;">
                                <div class="col col-lg-9 col-xl-7">
                                    ...
                                    <div>
                                        <p>Разработчик: <a
                                                href="{{route('categories.show',['slug'=>$product->category->slug]) }}">{{$product->razrab}}</a>
                                        </p>
                                    </div>
                                    <div>
                                        <p>Издатель: <a
                                                href="{{route('categories.show',['slug'=>$product->category->slug]) }}">{{$product->izdatel}}</a>
                                        </p>
                                    </div>
                                    <div class="px-3">
                                        @if($product->status)
                            ...
                            <div class="card-body p-4 text-black">
                                <div class="mb-5">
                                    ...
                                    <div class="p-4" style="background-color: #FFFFFF;">
                                        <button type="submit" class="btn btn-card-buy btn-block cart-addtocart">В
                                            корзину
                                        </button>
            ...
            @price_format($product->price) руб.
                                ...
                                <div class="row g-2">
                                    <div class="col mb-2">
                                        <img src="{{$product->getImage()}}" alt="{{$product->title}}" alt="image 1"
