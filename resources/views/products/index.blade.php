    ...
    <div id="myCarousel" class="vertical carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner  ">
            <div class="carousel-item active  ">
                <img src="../../public/assets/img/RE4.png" class="d-block w-100 "
                     alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="Menu">Resender Evil 4</h1>
                    <h1 class="Menu">5399 ₽</h1>
                </div>
            </div>
            <div class="carousel-item">
                <img src="../../public/assets/img/SF.jpg"
                     class="d-block w-100"
                     alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="Menu">StarField Оформить  предзаказ </h1>
                    <h1 class="Menu">4 990р ₽</h1>
                </div>
            </div>
            <div class="carousel-item">
                <img
                    src="../../public/assets/img/MK1.png"
                    class="d-block w-100" alt="...">
                <div class="carousel-caption d-none d-md-block">
                    <h1 class="Menu">Mortal Kombat предзаказ </h1>
                    <h1 class="Menu" >3700р ₽</h1>
                </div>
            </div>
        </div>
        ...
        <div class="carousel-indicators">
            ...
            <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="1" class="active" aria-current="true"
