...
<header>
    <div class="navbar shadow-sm">
        <div class="container">
            ...
            <a href="{{ url('register') }}" class="text-black btn btn-outline-warning" style="text-decoration: none">
                Регистрация </a>
            <a href="{{ route('login') }}" class="text-black btn btn-outline-warning" style="text-decoration: none">
                Авторизация </a>
            {{--            @endguest--}}
            {{--            @auth--}}
            <a href="#" class="text-black btn btn-outline-warning" style="text-decoration: none"> Создать пост </a>
            <a href="{{ url('logout') }}" class="text-black btn btn-outline-warning" style="text-decoration: none">
                Выход </a>
            {{--            @endauth--}}
